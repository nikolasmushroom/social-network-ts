import {ActionTypes, DialogsPageType, DialogType, MessageType, SendMessageType, UpdateNewMessageType} from "../../../app/store/store";
import {v1} from "uuid";
...
export const updateNewMessage = (newMessage: string) : UpdateNewMessageType => ({
